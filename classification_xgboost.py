...
# 初始化 TF-IDF 向量化器
vectorizer = TfidfVectorizer(min_df=2, max_df=0.9, stop_words="english", max_features=5000)

# 將文字資料轉換為 TF-IDF 特徵矩陣
X = vectorizer.fit_transform(texts)

# 使用 LabelEncoder 轉換 MBTI 類型標籤為數值型別
label_encoder = LabelEncoder()
y = label_encoder.fit_transform(labels)  # 將 MBTI 類型轉換為數字標籤
